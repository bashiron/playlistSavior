...
while True:
    pl_request = youtube.playlistItems().list(
        part='contentDetails',
        playlistId='PL_hXMzbIDwY6JUkTmCCoL1BwVIDHQpnRb',
        maxResults=50,
...
with open(f'C:/bashi/playlists/generated/smash {date.today()}.txt', 'xb') as fp:
    fp.write('\n'.join(parejas).encode('UTF-8'))

print('<<smash file created successfully>>')
